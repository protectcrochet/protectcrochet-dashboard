...
export async function POST(req: Request) {
  ...
  // 👇 leemos las cookies actuales (sesión) para que el RPC aplique RLS con tu usuario
  ...
  const supabase = createServerClient(
    ...
    process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY!,
    {
      cookies: {
        ...
        set(_name: string, _value: string, _opts: CookieOptions) {},   // no escribimos desde aquí
